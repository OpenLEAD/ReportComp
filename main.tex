...
\includepdf[pages=2-,
addtotoc={9,section,1,Nomenclatura,nomrelgel[,14,section,1,Introdução,introrelgel[,16,section,1,Descrição
do problema,desrelgel[,16,subsection,2,Viagem de
Reconhecimento,viarelgel[,26,subsection,2,Operação padrão de
inserção,operelgel[,28,subsection,2,Operação excepcional de inserção 1 -
Travamento durante inserção,ope1relgel[,29,subsection,2,Operação excepcional de
inserção 2 - Falha do desencaixe da garra
pescadora,ope2relgel[,29,subsection,2,Operação excepcional de inserção 3 - Não
vedamento devido ao acúmulo de detritos na base do
trilho,ope3relgel[,30,subsection,2,Operação padrão -
Remoção,operemrelgel[,31,subsection,2,Operação excepcional de remoção 1 - falha
no encaixe, operem1relgel[,32,subsection,2,Operação excepcional de remoção 2 -
Travamento durante remoção, operem2relgel[,32,subsection,2,Operação excepcional
de remoção 3 - Acúmulo de sedimentos no fundo,
operem3relgel[,34,section,1,Metodologia,metrelgel[,35,section,1,Pesquisa
Bibliogáica,
pesrelgel[,35,subsection,2,Stoplogs,stoplogsrelgel[,45,section,1,Projeto
Conceitual,projconrelgel[,45,subsection,2,Operação excepcional de inserção 1 -
Travamento durante inserção,ope12relgel[,46,subsection,2,Operação excepcional de
inserção 2 - Falha do desencaixe da garra
pescadora,ope22relgel[,47,subsection,2,Operação excepcional de inserção 3 - Não
vedamento devido ao acúmulo de detritos na base do trilho,
ope13relgel[,48,subsection,2,Operação excepcional de remoção 1 - Falha no
encaixe,ope12erelgel[,48,subsection,2,Operação excepcional de remoção 2 -
Travamento durante remoção, operem22relgel[,49,subsection,2,Operação excepcional
de remoção 3 - Acúmulo de sedimentos no
fundo,operem32relgel[,49,subsection,2,Conclusão do Conceito
Básico,concb2relgel[,51,section,1,Pesquisa
tecnológica,pestecrelgel[,52,subsection,2,Sensores de Contato,
sencontrelgel[,52,subsubsection,3,Sensor de
força,senforelgel[,54,subsubsection,3,Sensor indutivo de
proximidade,senindprorelgel[,56,subsubsection,3,Sensor capacitivo de
proximidade,sencaprelgel[,58,subsubsection,3,Conclusão de análise
técnica,contecrelgel[,60,subsection,2,Posição
Angular,posangrelgel[,60,subsubsection,3,Encoder,encrelgel[,61,subsubsection,3,Conclusão
de análise técnica,contec2relgel[,63,subsection,2,Mapeamento 3D,
maprelgel[,63,subsubsection,3,Sonar,sonrelgel[,68,subsubsection,3,Unidade
Pan e Tilt,pturelgel[,69,subsection,2,Reconstrução de superfície
3D,recsuprelgel[,74,subsection,2,Sistema de Gerenciamento de
Umbilical,sisgenrelgel[,76,section,1,Sistema
proposto,sisprorelgel[,76,subsection,2,Operação padrão (inspeção e
remoção),opepadinsremrelgel[,76,subsubsection,3,Sensores,sensoresrelgel[,77,subsubsection,3,Eletrônica
embarcada,eletembrelgel[,80,subsubsection,3,Umbilical,umbrelgel[,80,subsubsection,3,Eletrônica
de superfície - base, elesupbaserelgel[,80,subsubsection,3,Eletrônica de
superfície - remota,
elesupremrelgel[,80,subsubsection,3,Carretel,carretelrelgel[,81,subsection,2,Operação
Excepcional 1 - Inspeção,opeexcprelgel[,82,subsection,2,Operação Excepcional 2
- Remoção de sedimentos sobre olhal,olhalrelgel[,83,section,1,Fluxograma da
solução,fluxrelgel]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]}]{PDFs/RelGeral.pdf}
% ---------------------------------------------------------------------------
% ---------------------------------------------------------------------------

\chapter{Acompanhamentos e testes}
\include{acompetestes}

% ---------------------------------------------------------------------------
% ---------------------------------------------------------------------------

\chapter{Melhorias de processos}\label{chap::melpro}
\include{melhoriasdeprocessos}

% ---------------------------------------------------------------------------
% ---------------------------------------------------------------------------

\chapter{Melhorias introduzidas nos equipamentos}
\include{melhoriasdeequipamentos}
...
\includepdf[pages=-, addtotoc={1,section,1,Estudo realizado na definição e
desenvolvimento da interface do usuário,usu1[,1,subsection,2,Conceito do
Aplicativo ROSA,
usu11[,1,subsection,2,Referências,usu12[,3,subsection,2,Perfil do
Usuário,usu13[,3,subsection,2,Análise FOFA,usu14[,4,subsection,2,Características
de Funcionamento,usu15[,5,subsection,1,Jornada do
Usuário,usu16[,6,subsection,2,Casos de Uso,usu16[,7,subsection,2,Interface
Gráfica,usu17[,9,subsubsection,3,Dispositivos,usu171]]]]]]]]}]{PDFs/RelatorioUsabilidade.pdf}
...
\chapter{Capacitação tecnológica}
\include{capacitacaotec}
...
%\chapter{Relatório de Execução Financeira, amostras do auditor (REFP)} 
