...
do robô ROSA na usina de Jirau, cada uma instalada permanentemente em
uma viga pescadora.
...
tempo para execução da etapa. Na tabela \ref{tab::cronograma}, pode-se verificar
a descrição de cada item.

\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.3\linewidth]{PDFs/Plano_Trabalho.pdf}}
...
\hline
	...
	\caption{Descrição dos itens do cronograma de planejamento do projeto}
