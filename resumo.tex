...
suportar até 100 bar. Atualmente, o sistema está instalado e sendo
...
mergulhador foi arrastado pela correnteza da turbina adjacente e a corda de
segurança o segurou em um primeiro momento, porém o mesmo foi forçado a cortá-la
pois a pressão não o permitia respirar. O mergulhador foi arrastado pelo rio,
mas felizmente o acidente não foi fatal.
...
\textbf{Falhas}:
\begin{enumerate}
\item Não ensecamento de UG devido a detritos na soleira e guia lateral:
\begin{itemize}
...
\hline
	...
	7 & Design do Sistema & 5 & 3 & Processo de definicao da arquitetura, componentes, mó́dulos e interfaces que satisfazem os requisitos do sistema. \\ \hline
	8 & Manufatura \newline e Aquisicao & 5 & 4 & Compra e construçao
	dos componentes definidoss durante a fase de design do sistema. O resultado serão as partes que integradas formarão o robô.  \\ \hline 
	9 & Octomap & 5 & 4 & Integracao da biblioteca de acumulacao volumétrica ao software de robótica do projeto \\ \hline
	10 & Protótipo de Interface & 5 & 4 & Desenvolvimento de tela sinterativas
	simples, concentrando apenas no desenvolvimento da parte visual da interface. \\ \hline 
	11 & Drivers & 6 & 4 & Protocolos de comunicacao entre o computador embarcado e
	os sensores comprados \\ \hline 
	12 & Viajem Jirau - Teste de Sensor & 8 & 1 & Viagem a Jirau para teste simples dos sensores adiquiridos  \\ \hline
	\rowcolor{Gray}
	   & Execucao & 9 & 6 &  \\ \hline
	...
	Jirau \\ \hline & Encerramento & 15 & 2 &  & \  \\ \hline
